  ...
  foreach(arch ${architectures})
    if("${prefix}" STREQUAL "ANDROID")
      ...
      elseif("${prefix}" STREQUAL "EMSCRIPTEN")
        if(NOT arch STREQUAL "wasm32")
          message(FATAL_ERROR "unsupported arch for Emscripten: ${arch}")
        endif()
        set(SWIFT_SDK_EMSCRIPTEN_ARCH_wasm32_PATH "${SWIFT_EMSCRIPTEN_SYSROOT_PATH}")
        set(SWIFT_SDK_EMSCRIPTEN_ARCH_wasm32_TRIPLE "wasm32-unknown-emscripten")
